...
class NodeSetupVersionStage(Base):
    ...
    version_id: Mapped[str] = mapped_column(String, ForeignKey("node_setup_versions.id"), primary_key=True)
    stage_id: Mapped[str] = mapped_column(String, ForeignKey("stages.id"), primary_key=True)
